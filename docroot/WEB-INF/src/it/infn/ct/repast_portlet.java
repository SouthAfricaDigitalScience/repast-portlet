 ...
 * @author <a href="mailto:riccardo.bruno@ct.infn.it">Riccardo Bruno</a>(COMETA)
 */
public class repast_portlet extends GenericPortlet {

    // Instantiate the logger object
    AppLogger _log = new AppLogger(repast_portlet.class);
    ...
    */
    ...
    void __submitJob(AppInput appInput) {
        ...
        if(infrastructuresInfo.length > 0) {
            ...
            String outputFile="repast-infection-Output.txt";           // Distributed application standard output
            String errorFile ="repast-infection-Error.txt";            // Distrubuted application standard error
            String appFile   ="repast-infection-files.tar.gz";         // Hostname output files (created by the pilot script)
